...
std::string EulerXYZ::ToString() const {
  ...
  str += "( x-axis: " + math_util::FloatingPointNumToString(x_angle) +
         " [rad], y-axis : " + math_util::FloatingPointNumToString(y_angle) +
         " [rad], z-axis: " + math_util::FloatingPointNumToString(z_angle) +
         " [rad]) xyz-euler angles";
...
std::string EulerXYZ::ToStringDeg() const {
  ...
  str +=
      "( x-axis: " + FloatingPointNumToString(ConvertRadToDeg(x_angle)) +
      " [deg], y-axis : " + FloatingPointNumToString(ConvertRadToDeg(y_angle)) +
