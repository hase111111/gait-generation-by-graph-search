...
//! @file application_setting_record_validator.cpp
...
ApplicationSettingRecordValidator::ApplicationSettingRecordValidator()
    : kErrorMesForWindowWidthGeMin(
          std::format("The window width should be set to a value greater than "
                      "or equal to {}.",
      ...
      kErrorMesForWindowHeightGeMin(
          std::format("The window height should be set to a value greater than "
                      "or equal to {}.",
                      ApplicationSettingRecord::kWindowHeightMin)),

      kErrorMesForWindowHeightLeMax(
          std::format("The window height should be set to a value less than or "
                      "equal to {}.",
                      ApplicationSettingRecord::kWindowHeightMax)),

      kErrorMesForFpsGeMin(
          std::format("FPS should be set to a value greater than {}.",
                      ApplicationSettingRecord::kFpsMin)),

      kErrorMesForFpsLeMax(
          std::format("FPS should be set to a value less than or equal to {}.",
...
{
  if (setting_record.window_size_x <
      ApplicationSettingRecord::kWindowWidthMin) {
  ...
  if (setting_record.window_size_y <
      ApplicationSettingRecord::kWindowHeightMin) {
