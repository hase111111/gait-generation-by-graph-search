...
DxlibGuiCamera::DxlibGuiCamera(const int window_x, const int window_y,
  ...
  button_.push_back(std::make_unique<SimpleButton>(
      "Front", left_pos_x + button_range, top_pos_y, button_size, button_size));
  ...
  button_.push_back(std::make_unique<SimpleButton>(
      "Top", left_pos_x + button_range, top_pos_y + button_range, button_size,
      button_size));
  button_.back()->SetActivateFunction([this]() {
  ...
  button_.push_back(std::make_unique<SimpleButton>(
      "Reset\nTarget", left_pos_x + button_range * 2, top_pos_y, button_size,
      button_size));
  button_.back()->SetActivateFunction([this]() {
