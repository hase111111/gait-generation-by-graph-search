...
struct SimulationMapParameter final {
 public:
  ...
  constexpr void SetMapSize(const float max_x, const float min_x,
                            const float max_y, const float min_y,
                            const float start_rough_x, const float map_base_z) {
    assert(min_x < max_x);
    assert(min_y < max_y);
  ...
  constexpr void SetTiltAngle(const float angle) { tilt_angle = angle; }

  constexpr void SetSlopeAngle(const float angle) { slope_angle = angle; }

  constexpr void SetRouthHeight(const float height_min,
...
DESIGNLAB_TOML11_DESCRIPTION_CLASS(SimulationMapParameter) {
  ...
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(base_z, "Basic",
                                            "マップの基準となるZ座標．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(map_max_x, "Basic",
                                            "マップのX座標の最大値．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(map_min_x, "Basic",
                                            "マップのX座標の最小値．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(map_max_y, "Basic",
                                            "マップのY座標の最大値．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(map_min_y, "Basic",
                                            "マップのY座標の最小値．");
  ...
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(
      ...
      "デコボコな地形の最大高さ[mm]．最小値より大きい値にすること．");
  ...
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(circle_radius, "Circle",
                                            "円 / ドーナツの半径．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(donut_radius, "Circle",
                                            "ドーナツの内側の半径．");

  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(radial_center, "Radial",
                                            "放射状の地形の中心座標．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(radial_division, "Radial",
                                            "放射状の地形の分割数．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(radial_hole_rate, "Radial",
                                            "放射状の地形のホール率[%]．");
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(
