...
//! @file graphic_main_robot_control.cpp
...
GraphicMainRobotControl::GraphicMainRobotControl(
  ...
  const auto robot_control_gui = std::make_shared<DxlibGuiRobotControl>(
      setting_ptr->window_size_x, setting_ptr->window_size_y, converter_ptr,
      calculator_ptr, checker_ptr);
  robot_control_gui->SetPos(10, setting_ptr->window_size_y - 10,
