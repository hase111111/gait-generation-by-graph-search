...
void TempMakeMaps() {
  ...
  std::vector<Temp> temp_vec{
      ...
      {"flat_slanted_stripe_-30deg_40x", kSlantedStripes, 0, 2, 0, -30.f},
      {"flat_slanted_stripe_-30deg_60x", kSlantedStripes, 0, 3, 0, -30.f},
      {"flat_slanted_stripe_-30deg_80x", kSlantedStripes, 0, 4, 0, -30.f},
      {"flat_slanted_stripe_-30deg_100x", kSlantedStripes, 0, 5, 0, -30.f},
      {"flat_slanted_stripe_-45deg_40x", kSlantedStripes, 0, 2, 0, -45.f},
      {"flat_slanted_stripe_-45deg_60x", kSlantedStripes, 0, 3, 0, -45.f},
      {"flat_slanted_stripe_-45deg_80x", kSlantedStripes, 0, 4, 0, -45.f},
      {"flat_slanted_stripe_-45deg_100x", kSlantedStripes, 0, 5, 0, -45.f},
      {"flat_slanted_stripe_-60deg_40x", kSlantedStripes, 0, 2, 0, -60.f},
      {"flat_slanted_stripe_-60deg_60x", kSlantedStripes, 0, 3, 0, -60.f},
      {"flat_slanted_stripe_-60deg_80x", kSlantedStripes, 0, 4, 0, -60.f},
      {"flat_slanted_stripe_-60deg_100x", kSlantedStripes, 0, 5, 0, -60.f},
