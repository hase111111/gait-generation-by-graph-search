...
public:
	...
	INodeCreator(const DevideMapState& map_ref, const std::shared_ptr<const AbstractHexapodStateCalculator>& calc, const EHexapodMove next_move) : m_next_move(next_move) {};
