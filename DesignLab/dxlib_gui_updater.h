...
class DxlibGuiUpdater final {
 ...
 private:
  ...
  void RegisterClickable(const std::shared_ptr<IDxlibClickable> clickable_ptr,
                         int priority);
  void RegisterDraggable(const std::shared_ptr<IDxlibDraggable> draggable_ptr,
                         int priority);
  void RegisterWheelHandler(
      const std::shared_ptr<IDxlibWheelHandler> wheel_handler_ptr,
      int priority);
