...
class XrR1Const final {
 ...
 public:
  ...
  constexpr static std::array<float, kPhantomXLegNum> kCoxaDefaultAngle = {
      math_util::ConvertDegToRad(-45.0f),  math_util::ConvertDegToRad(-90.0f),
      math_util::ConvertDegToRad(-135.0f), math_util::ConvertDegToRad(135.0f),
      math_util::ConvertDegToRad(90.0f),   math_util::ConvertDegToRad(45.0f)};
  ...
  constexpr static bool IsValidCoxaAngle(const int leg_index,
