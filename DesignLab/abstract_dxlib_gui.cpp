...
void AbstractDxlibGui::SetPos(const int pos_x, const int pos_y,
...
bool AbstractDxlibGui::CursorOnGui(const int cursor_x,
...
void AbstractDxlibGui::DraggedAction(int cursor_dif_x, int cursor_dif_y,
                                     unsigned int mouse_key_bit) {
  if (!(mouse_key_bit & MOUSE_INPUT_LEFT)) {
    return;
  }

  SetPos(gui_left_pos_x_ + cursor_dif_x, gui_top_pos_y_ + cursor_dif_y,
...
void AbstractDxlibGui::DrawBackground(const std::string& str) const {
  ...
  DrawBox(gui_left_pos_x_ - frame_width, gui_top_pos_y_ - frame_width,
          ...
          gui_top_pos_y_ + height_ + frame_width, frame_color, TRUE);
  DrawBox(gui_left_pos_x_, gui_top_pos_y_, gui_left_pos_x_ + width_,
          gui_top_pos_y_ + height_, base_color, TRUE);

  DrawBox(gui_left_pos_x_, gui_top_pos_y_, gui_left_pos_x_ + width_,
          gui_top_pos_y_ + kTitleBarHeight, base_color, TRUE);
  DrawBox(gui_left_pos_x_ - frame_width, gui_top_pos_y_ - frame_width,
          gui_left_pos_x_ + width_ + frame_width,
          gui_top_pos_y_ + kTitleBarHeight + frame_width, frame_color, FALSE);
  ...
  DrawFormatStringToHandle(text_pos_x, text_pos_y, text_color, font_handle_,
                           str.c_str());
