...
class PhantomXMkII : public IHexapodCoordinateConverter,
 ...
 public:
  ...
  Vector3 ConvertGlobalToLegCoordinate(const Vector3& converted_position,
                                       int leg_index,
                                       const Vector3& center_of_mass_global,
                                       const Quaternion& robot_quat,
                                       const bool consider_rot) const override;

  Vector3 ConvertLegToGlobalCoordinate(const Vector3& converted_position,
                                       int leg_index,
                                       const Vector3& center_of_mass_global,
                                       const Quaternion& robot_quat,
                                       const bool consider_rot) const override;
  ...
  Vector3 ConvertRobotToLegCoordinate(const Vector3& converted_position,
                                      int leg_index) const;

  Vector3 ConvertLegToRobotCoordinate(const Vector3& converted_position,
                                      int leg_index) const;
  ...
  float CalculateStabilityMargin(
 ...
 private:
  ...
  const std::array<Vector3, HexapodConst::kLegNum>
