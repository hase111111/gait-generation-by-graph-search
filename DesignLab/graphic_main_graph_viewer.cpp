...
//! @file graphic_main_graph_viewer.cpp
...
GraphicMainGraphViewer::GraphicMainGraphViewer(
    ...
    : broker_ptr_(broker_ptr),
      ...
      graph_({}),
      gui_controller_ptr_(std::make_unique<GraphViewerGUIController>(
          &graph_, &display_node_index_, setting_ptr)) {
  ...
  camera_gui->SetPos(10, setting_ptr->window_size_y - 10,
                     kDxlibGuiAnchorLeftBottom, true);
