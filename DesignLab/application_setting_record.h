...
DESIGNLAB_TOML11_DESCRIPTION_CLASS(ApplicationSettingRecord) {
  const std::vector<std::string> kFileDescription = {
      ...
      "This file is written in utf - 8, and can be read by installing VS Code "
      "and "
      ...
      "Lines starting with a sharp are comments. They do not affect the "
      "program."};
  ...
  DESIGNLAB_TOML11_VARIABLE_ADD_DESCRIPTION(do_gui_display, "Output",
