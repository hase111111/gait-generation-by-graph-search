...
Vector3 RotateVector3(const Vector3& vec, const RotationMatrix3x3& rot) {
  ...
  res.x = rot.element[0][0] * vec.x + rot.element[0][1] * vec.y +
          rot.element[0][2] * vec.z;
  res.y = rot.element[1][0] * vec.x + rot.element[1][1] * vec.y +
          rot.element[1][2] * vec.z;
  res.z = rot.element[2][0] * vec.x + rot.element[2][1] * vec.y +
          rot.element[2][2] * vec.z;
