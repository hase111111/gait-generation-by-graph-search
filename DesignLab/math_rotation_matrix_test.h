...
TEST_SUITE("RotationMatrix3x3") {
  ...
  TEST_CASE("ConstructorTest_ShouldCreateArbitraryMatrix") {
    // 任意の行列を生成する.
    const RotationMatrix3x3 rot_mat(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f,
                                    8.0f, 9.0f);
  ...
  TEST_CASE("ArithmeticOperatorTest") {
    SUBCASE("Multiplication") {
      // 任意の行列を生成する.
      const RotationMatrix3x3 rot_mat1(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f,
                                       8.0f, 9.0f);

      // 任意の行列を生成する.
      const RotationMatrix3x3 rot_mat2(9.0f, 8.0f, 7.0f, 6.0f, 5.0f, 4.0f, 3.0f,
                                       2.0f, 1.0f);

      const RotationMatrix3x3 actual = rot_mat1 * rot_mat2;

      // 任意の行列を生成する.
      const RotationMatrix3x3 expect(30.0f, 24.0f, 18.0f, 84.0f, 69.0f, 54.0f,
                                     138.0f, 114.0f, 90.0f);
