...
designlab::Vector3 DividedMapState::GetPointPos(int x_index, int y_index, int devide_map_index) const
{
    //存在していなければ終了
...
void DividedMapState::GetPointVector(int x_index, int y_index, std::vector<designlab::Vector3>* point_vec) const
{
