...
bool ComSelecterHato::getComFromPolygon(const my_vec::SPolygon2& polygon, const ComType::EComPattern _com_pattren, my_vec::SVector& _output_com) const
{
	...
	if (DO_DEBUG_PRINT)
	{
		std::cout << ComType::convertComPatternToBit(_com_pattren) << "の重心は見つからなかった" << std::endl;
	}
...
void ComSelecterHato::makeComCandidatePoint(const my_vec::SPolygon2& polygon, std::vector<my_vec::SVector2>& _coms) const
{
...
bool ComSelecterHato::isInMargin(const my_vec::SPolygon2& polygon, const my_vec::SVector2& _com) const
{
