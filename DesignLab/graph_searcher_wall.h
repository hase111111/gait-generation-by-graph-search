...
//! @file graph_searcher_wall.h

// Copyright(c) 2023-2025 Design Engineering Laboratory, Saitama University
// Released under the MIT license
// https://opensource.org/licenses/mit-license.php

#ifndef DESIGNLAB_GRAPH_SEARCHER_WALL_H_
#define DESIGNLAB_GRAPH_SEARCHER_WALL_H_
...
//! @class GraphSearcherWall
//! @brief グラフ探索を行い,直進する動作を評価するクラス.
class GraphSearcherWall final : public IGraphSearcher {
  using Tag = GraphSearchEvaluationValue::Tag;

 public:
  explicit GraphSearcherWall(
...
#endif  // DESIGNLAB_GRAPH_SEARCHER_WALL_H_
