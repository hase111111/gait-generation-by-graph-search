...
//! @file node_creator_leg_up_down_pruning_branch.h

// Copyright(c) 2023-2025 Design Engineering Laboratory, Saitama University
// Released under the MIT license
// https://opensource.org/licenses/mit-license.php

#ifndef DESIGNLAB_NODE_CREATOR_LEG_UP_DOWN_PRUNING_BRANCH_H_
#define DESIGNLAB_NODE_CREATOR_LEG_UP_DOWN_PRUNING_BRANCH_H_
...
//! @class NodeCreatorLegUpDownPruningBranch
//! @brief
//! 脚の上げ下げをするエッジ(辺,ノードとノードを繋ぐ物)の処理をするクラス.
class NodeCreatorLegUpDownPruningBranch final : public INodeCreator {
 public:
  NodeCreatorLegUpDownPruningBranch(
  ...
  ~NodeCreatorLegUpDownPruningBranch() = default;
