...
void NodeCreatorLegHierarchy::Create(const RobotStateNode& current_node,
...
void NodeCreatorLegHierarchy::Create1LegLifted(const RobotStateNode& current_node,
                                               const int current_node_index,
                                               std::vector<RobotStateNode>* output_graph) const
{
...
void NodeCreatorLegHierarchy::Create2LegLifted(const RobotStateNode& current_node,
                                               const int current_node_index,
                                               std::vector<RobotStateNode>* output_graph) const
{
...
void NodeCreatorLegHierarchy::Create3LegLifted(const RobotStateNode& current_node,
                                               const int current_node_index,
                                               std::vector<RobotStateNode>* output_graph) const
{
