...
//! @file movement_locus_renderer.cpp
...
void MovementLocusRenderer::SetSimulationEndIndexes(
...
void MovementLocusRenderer::SetMoveLocusPoint(
    const std::vector<RobotStateNode>& locus) {
