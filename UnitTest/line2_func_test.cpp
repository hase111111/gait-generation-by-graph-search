...
namespace dl_vec_test
{
	TEST(SLine2, GetIntersection)
	{
		...
		designlab::SLine2 line1 = designlab::SLine2({ 0, 0 }, { 1, 1 });
		designlab::SLine2 line2 = designlab::SLine2({ 0, 1 }, { 1, 2 });
		EXPECT_EQ(line1.getIntersection(line2), designlab::SVector2(0, 0));

		//辺が平行でない場合交点がある
		line1 = designlab::SLine2({ 0, 0 }, { 1, 1 });
		line2 = designlab::SLine2({ 0, 1 }, { 1, 0 });
		EXPECT_EQ(line1.getIntersection(line2), designlab::SVector2(0.5, 0.5));

		//辺の向きが逆でも交点は同じ
		line1 = designlab::SLine2({ 0, 0 }, { 1, 1 });
		line2 = designlab::SLine2({ 1, 0 }, { 0, 1 });
		EXPECT_EQ(line1.getIntersection(line2), designlab::SVector2(0.5, 0.5));

		line1 = designlab::SLine2({ 1,1 }, { 0,0 });
		line2 = designlab::SLine2({ 0,1 }, { 1,0 });
		EXPECT_EQ(line1.getIntersection(line2), designlab::SVector2(0.5, 0.5));

		//辺の長さが足りず，接していない場合交点はない，(0,0)が返る
		line1 = designlab::SLine2({ 0, 0 }, { 1, 1 });
		line2 = designlab::SLine2({ -5,-6 }, { -3,-1 });
		EXPECT_EQ(line1.getIntersection(line2), designlab::SVector2(0, 0));

		//端点で接する場合，その点が返る．
		line1 = designlab::SLine2({ 0, 0 }, { 1, 1 });
		line2 = designlab::SLine2({ 1, 1 }, { 2, 3 });
	...
	TEST(SLine2, GetLength)
	{
		...
		line1 = designlab::SLine2({ 0, 0 }, { 1, 0 });
		EXPECT_FLOAT_EQ(line1.getLength(), 1.0f);

		line1 = designlab::SLine2({ 0, 0 }, { 0, 1 });
		EXPECT_FLOAT_EQ(line1.getLength(), 1.0f);

		line1 = designlab::SLine2({ 0, 0 }, { 0, 0 });
		EXPECT_FLOAT_EQ(line1.getLength(), 0.0f);

		line1 = designlab::SLine2({ 0, 0 }, { 1, 2 });
		EXPECT_FLOAT_EQ(line1.getLength(), sqrt(5.0f));

		line1 = designlab::SLine2({ 0, 0 }, { 2, 1 });
		EXPECT_FLOAT_EQ(line1.getLength(), sqrt(5.0f));

		line1 = designlab::SLine2({ 0, 0 }, { 2, 2 });
	...
	TEST(SLine2, IsParallel)
	{
		...
		line1 = designlab::SLine2({ 10, 0 }, { 0, 0 });
		line2 = designlab::SLine2({ 0, 0 }, { -400, 0 });
		EXPECT_TRUE(line1.isParallel(line2));

		line1 = designlab::SLine2({ 35, 70 }, { 35, -200 });
		line2 = designlab::SLine2({ -14.7f, -300 }, { -14.7f, 2000 });
		EXPECT_TRUE(line1.isParallel(line2));
