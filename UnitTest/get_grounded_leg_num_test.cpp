...
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 6);
//
//
//		// テストケース2 一部脚接地 ( 3脚 )
//		bool is_ground2_1[HexapodConst::kLegNum] = { true, false, true, false, true, false };
//		res = dllf::MakeLegStateBit(com, is_ground2_1, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 3);
//
//		bool is_ground2_2[HexapodConst::kLegNum] = { false, true, false, true, false, true };
//		res = dllf::MakeLegStateBit(com, is_ground2_2, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 3);
//
//		bool is_ground2_3[HexapodConst::kLegNum] = { false, false, true, true, false, true };
//		res = dllf::MakeLegStateBit(com, is_ground2_3, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 3);
//
//
//		// テストケース3 全脚非接地
//		bool is_ground3[HexapodConst::kLegNum] = { false, false, false, false, false, false };
//		res = dllf::MakeLegStateBit(com, is_ground3, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 0);
//
//
//		// テストケース4 一部脚接地 ( 4脚 )
//		bool is_ground4_1[HexapodConst::kLegNum] = { false, true, true, true, false, true };
//		res = dllf::MakeLegStateBit(com, is_ground4_1, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 4);
//
//		bool is_ground4_2[HexapodConst::kLegNum] = { true, false, true, true, true, false };
//		res = dllf::MakeLegStateBit(com, is_ground4_2, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 4);
//
//		bool is_ground4_3[HexapodConst::kLegNum] = { true, true, false, true, false, true };
//		res = dllf::MakeLegStateBit(com, is_ground4_3, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 4);
//
//		bool is_ground4_4[HexapodConst::kLegNum] = { true, true, true, false, true, false };
//		res = dllf::MakeLegStateBit(com, is_ground4_4, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 4);
//
//
//		// テストケース5 一部脚接地 ( 5脚 )
//		bool is_ground5_1[HexapodConst::kLegNum] = { false, true, true, true, true, true };
//		res = dllf::MakeLegStateBit(com, is_ground5_1, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 5);
//
//		bool is_ground5_2[HexapodConst::kLegNum] = { true, false, true, true, true, true };
//		res = dllf::MakeLegStateBit(com, is_ground5_2, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 5);
//
//		bool is_ground5_3[HexapodConst::kLegNum] = { true, true, false, true, true, true };
//		res = dllf::MakeLegStateBit(com, is_ground5_3, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 5);
//
//		bool is_ground5_4[HexapodConst::kLegNum] = { true, true, true, false, true, true };
//		res = dllf::MakeLegStateBit(com, is_ground5_4, discretized_leg_pos);
//		EXPECT_EQ(dllf::GetGroundedLegNum(res), 5);
//	}
//}